...
class HandKeypointDataset(Dataset):
    def __init__(self, xml_path='xml_labels', image_dir='png', transform=None, mode_map=None, action_map=None):
        """
        Args:
            ...
            mode_map (dict): Mapping of mode strings to numerical labels.
            action_map (dict): Mapping of action strings to numerical labels.
        """
        self.xml_path = xml_path
        self.image_dir = image_dir
        self.transform = transform
        self.mode_map = mode_map if mode_map is not None else {} # Provide default if not given
